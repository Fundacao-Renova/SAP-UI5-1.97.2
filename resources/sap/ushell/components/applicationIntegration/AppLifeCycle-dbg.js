...
sap.ui.define([
    ...
    function AppLifeCycle () {
        ...
        this.leave = function (oCurrentAppContainer, sCurrentPageId, oTargetAppContainer) {
            var bReuseStatefulContainer = BlueBoxHandler.isStatefulContainerSupported(oCurrentAppContainer);
            var oStorageEntry = Storage.get(sCurrentPageId);

            if (oStorageEntry) {
                RelatedServices.store(oStorageEntry.service);
            }
            if (oCurrentAppContainer === oTargetAppContainer && bReuseStatefulContainer) {
                return this.handleExitStateful(sCurrentPageId, oCurrentAppContainer);
            }
        ...
        this.handleControl = function (sIntent, sAppId, oShellHash, oTarget, fnWrapper, sFixedShellHash) {
            ...
            var oPromise = that.leave(oCurrentAppContainer, sCurrentPageId, oTargetAppContainer).then(function() {
