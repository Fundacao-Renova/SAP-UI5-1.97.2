...
sap.ui.define([
    ...
    return Controller.extend(COMPONENT_NAME, {
        ...
        */
        ...
        _getFooterColor: function (sFooterColor) {
            if (sFooterColor === "Positive") {
                sFooterColor = mobileLibrary.ValueColor.Good;
            }
            if (sFooterColor === "Negative") {
                sFooterColor = mobileLibrary.ValueColor.Error;
            }

            if (!mobileLibrary.ValueColor[sFooterColor]) {
                sFooterColor = mobileLibrary.ValueColor.Neutral;
            }

            return sFooterColor;
        },

        _getValueColor: function (sState) {
            if (!sState || sState === mobileLibrary.ValueColor.Neutral || !mobileLibrary.ValueColor[sState]) {
                return mobileLibrary.ValueColor.None;
            }
            return sState;
        }
    });
