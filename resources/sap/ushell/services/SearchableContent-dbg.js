        ...
        return sap.ushell.Container.getServiceAsync("LaunchPage")
            ...
            .then(function (aLaunchPageTiles) {
                return Promise.all(aLaunchPageTiles.map(function (oTile) {
                    ...
                    if (!this._oLaunchPageService.getCatalogTilePreviewTitle(oTile)) {
                ...
                aTileData.forEach(function (oTileData) {
                    ...
                    if (oTileView) {
                        if (!oTileView.destroy) {
                            var sId = this._oLaunchPageService.getCatalogTileId(oTileData.tile)
                            || this._oLaunchPageService.getTileId(oTileData.tile);
                            Log.error("The tile with id '" + sId + "' does not implement mandatory function destroy");
                        } else {
                            oTileView.destroy();
                        }
                    }
