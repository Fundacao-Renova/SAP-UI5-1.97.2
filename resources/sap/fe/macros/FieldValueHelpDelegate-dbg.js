...
sap.ui.define(
	...
	function(FieldValueHelpDelegate, ValueListHelper, CommonUtils) {
		 ...
		 *
		 * @param {object} oPayload Payload for the delegate
		 * @param {sap.ui.mdc.base.FieldHelpBase} oFieldHelp Field help instance
		 ...
		 *
		 * @param {object} oPayload Payload for the delegate
		 * @param {boolean} bTypeahead True if the search is called for a type-ahead
		 * @param {string} sSearch Search string
		 * @returns {string|undefined} Search string to be used
		 */
