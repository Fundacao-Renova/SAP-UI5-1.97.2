	...
	function(
		...
		var FieldHelper = {
			...
			computeLabelText: function(oDataField, oInterface) {
				...
				var sDataFieldLabel = oModel.getObject(sContextPath + "/Label");
				...
				var sDataFieldValueLabel = oModel.getObject(sContextPath + "/Value/$Path@com.sap.vocabularies.Common.v1.Label");
			 ...
			 * @param {object} oThis The current object
			 * @param {string} sPropertyType The property type
			 * @param {string} sPropertyMultiLineText The property MultiLineText
			 * @returns {*} The binding expression to determine if a data field should be a MultiLineText or not
			 */
			 ...
			 * @param {object} oInterface The interface for the context instance
