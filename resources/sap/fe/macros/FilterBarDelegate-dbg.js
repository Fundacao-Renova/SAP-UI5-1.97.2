...
sap.ui.define(
	...
	function(
		...
		ODataFilterBarDelegate._fetchBasicPropertyInfo = function(oFilterFieldInfo) {
			return {
		...
		function _fetchPropertyInfo(oMetaModel, oFilterFieldInfo) {
			var oPropertyInfo = ODataFilterBarDelegate._fetchBasicPropertyInfo(oFilterFieldInfo),
		...
		ODataFilterBarDelegate.fetchPropertiesForEntity = function(sEntityTypePath, oMetaModel, oFilterControl) {
			...
			if (oFilterControl.data("showDraftEditState") === "true") {
