...
sap.ui.define([], function() {
	...
	var ModelHelper = {
		 ...
		 *
		 * @param {Context} oContext Context to be used
		 * @returns {string | undefined} Returns meta path for the context.
		 */
		 ...
		 *
		 * @param {View} oView View of the control using listBinding
		 * @param {ODataListBinding | string} vListBinding ODataListBinding object or the binding path for a temporary list binding
		 * @returns {string | undefined} Returns meta path for the listbinding.
		 */
