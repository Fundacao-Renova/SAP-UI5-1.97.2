...
sap.ui.define(["sap/ui/base/Object",
	...
	function getMethods(oTemplateContract, oNavigationControllerProxy) {
		...
		function getSpecialDraftCancelPromise(oContext){
			...
			return oOptionPromise && oOptionPromise.then(function(oOption) {
				return fnNavigateToRoute.bind(null, oOption);
			});
		}
		...
		function fnHandleRouteMatched() {
		  ...
		  */
			if (!bEnablePlaceholder || isBackwards()){ 
				fnHidePlaceholder();
			} else if (oCurrentIdentity.treeNode.sRouteName === "root" && oCurrentIdentity.treeNode.componentId) {
