 ...
 */
sap.ui.define(
	["./BaseShape", "./RenderUtils", "./GanttUtils", "../misc/Format", "sap/ui/Device"],
	function (BaseShape, RenderUtils, GanttUtils, Format, Device) {
		"use strict";
		...
		BaseDeltaRectangle.prototype.onmouseover = function (oEvent) {
			oEvent.iOffsetX = this._getPopoverOffsetX(oEvent);
			this.fireMouseEnter(oEvent);
		};

		BaseDeltaRectangle.prototype._getPopoverOffsetX = function (oEvent) {
			if (this.getWidth()) {
				var fShapeWidth = this.getWidth();
				...
				var iResult = Math.round((fShapeX + fShapeWidth) - iEventOffsetX);
				return iResult;
			}
		};
