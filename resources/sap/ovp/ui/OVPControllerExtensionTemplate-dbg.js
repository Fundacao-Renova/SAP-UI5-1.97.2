sap.ui.define([
	"sap/ui/core/mvc/Controller", "sap/ui/core/mvc/ControllerExtension", "sap/m/MessageToast", "sap/ui/util/openWindow"],
	function (Controller, ControllerExtension, MessageToast, openWindow) {
		"use strict";
		return ControllerExtension.extend("{{controllerExtensionName}}", {
			...
			// 			openWindow("https://www.google.co.in", "newWindow");
			// 		},

			// 		press2: function (oEvent) {
			// 			openWindow("http://www.sap.com/index.html", "newWindow");
			// 		},
