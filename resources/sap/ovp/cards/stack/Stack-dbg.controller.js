...
//                    var oComponentContainer = new ComponentContainer();
            ...
            openStack: function () {
                ...
                if (this.oObjectStream.getNewContentAvailable()) {
                    var quickViewCardPromiseArray = [];
                    var cardsInitiallyLoaded = (this.quickViewCardContextArray.length <= this.initialLoadCardLength) ? this.quickViewCardContextArray.length : this.initialLoadCardLength;
