...
sap.ui.define([
	...
	var ControlProvider = function(mPropertyBag) {
		if (mPropertyBag) {
			...
			this._oTextInEditModeSource = mPropertyBag.textInEditModeSource;
		}
	...
	ControlProvider.prototype._getTextInEditModeSource = function(oViewField) {
		if (!this._oTextInEditModeSource) {
			return compLibrary.smartfield.TextInEditModeSource.None;
		}

		return this._oTextInEditModeSource[oViewField.name] || this._oTextInEditModeSource["*"];
	};
