...
sap.ui.define([
	...
	var FormatUtil = {
		 ...
		 * @private
		 */
		getFormatterFunctionFromDisplayBehaviour: function(sDisplayBehaviour, bReplaceWhitespace) {
			var sProcessMethod = bReplaceWhitespace ? "Whitespace" : "";
			switch (sDisplayBehaviour) {
				case "descriptionAndId":
					return FormatUtil["_get" + sProcessMethod + "TextFormatterForDescriptionAndId"];
				case "idAndDescription":
					return FormatUtil["_get" + sProcessMethod + "TextFormatterForIdAndDescription"];
				case "descriptionOnly":
					return FormatUtil["_get" + sProcessMethod + "TextFormatterForDescriptionOnly"];
					// idOnly and fallback to Id in case nothing was specified
				default:
					return FormatUtil["_get" + sProcessMethod + "TextFormatterForIdOnly"];
			}
		},
		 ...
		 */
		getInlineGroupFormatterFunction: function(oFieldMetadata, bDisableDescription, oDateFormatSettings, bPreserveDecimals, bReplaceWhitespace) {
