...
sap.ui.define(["sap/ui/thirdparty/jquery", "./BaseController", "./DraftController", "sap/ui/generic/app/util/ModelUtil", "sap/base/util/extend"], function (jQuery, BaseController, DraftController, ModelUtil, extend) {
	"use strict";
	...
	TransactionController.prototype.getDefaultValues = function (oContext, oPredefinedValue, sNavigationProperty, sFunctionImportName) {
		var oEntityObject, aEntityTypeProperties;
			...
			var oPromise = this._callAction(sDefaultValueFunctionPath, oContext, mParameters).then(function (oResponse) {
				if (oResponse.httpResponse.statusCode === "200") {
					...
					if (oPredefinedValue) {
						...
						oPredefinedValue = extend({}, oExistingValues, oDefaultValue);
					} else {
