...
sap.ui.define([
	...
	Billboard.prototype._billboardViewUpdate = function(renderer, camera) {
		...
		if (this._vkGetNodeContentType() === NodeContentType.Symbol) {
			...
			// camera position may differ from (0,0,0) when this method is called from viewport.getObjectImage()
			var pos = this.getWorldPosition(new THREE.Vector3()).sub(camera.getWorldPosition(new THREE.Vector3()));
