...
sap.ui.require.preload({
	"sap/zen/commons/manifest.json":'{"_version":"1.21.0","sap.app":{"id":"sap.zen.commons","type":"library","embeds":[],"applicationVersion":{"version":"1.97.0"},"title":"Layout components used by Design Studio.","description":"Layout components used by Design Studio.  NOT INTENDED FOR STANDALONE USAGE.","ach":"BI-RA-AD-EA","resources":"resources.json","offline":true},"sap.ui":{"technology":"UI5","supportedThemes":["base","sap_belize","sap_belize_hcb","sap_belize_hcw","sap_belize_plus","sap_bluecrystal","sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_hcb","sap_horizon"]},"sap.ui5":{"dependencies":{"minUI5Version":"1.97","libs":{"sap.ui.core":{"minVersion":"1.97.0"},"sap.ui.layout":{"minVersion":"1.97.0"},"sap.m":{"minVersion":"1.97.0"}}},"library":{"i18n":false,"content":{"controls":["sap.zen.commons.layout.AbsoluteLayout","sap.zen.commons.layout.MatrixLayout","sap.zen.commons.Grid"],"elements":["sap.zen.commons.layout.MatrixLayoutCell","sap.zen.commons.layout.MatrixLayoutRow","sap.zen.commons.layout.PositionContainer","sap.zen.commons.Cell"],"types":["sap.zen.commons.BackgroundDesign","sap.zen.commons.HAlign","sap.zen.commons.Padding","sap.zen.commons.Separation","sap.zen.commons.VAlign","sap.zen.commons.AlertLevel","sap.zen.commons.CellType","sap.zen.commons.Format"],"interfaces":[]}}}}'
